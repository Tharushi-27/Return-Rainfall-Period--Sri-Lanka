...
# Load data
df = pd.read_csv("C:/Users/DELL/Desktop/all district/ratnapura/CSV_MUTWAGALLA ESTATE.csv")
...
plt.title("Return Period vs Rainfall - Mutwagalla Estate (POT-GPD Method)")
plt.grid(True)
plt.show()
