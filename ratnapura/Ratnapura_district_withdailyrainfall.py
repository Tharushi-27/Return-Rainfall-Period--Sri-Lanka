...
# Load data
df = pd.read_csv("C:/Users/DELL/Desktop/all district/CSV_Extreme_Rainfall_By_Day_ratnapura.csv")
...
plt.title('Return Period vs Rainfall for Ratnapura District using daily rainfall (1900-2025) ')
plt.show()
