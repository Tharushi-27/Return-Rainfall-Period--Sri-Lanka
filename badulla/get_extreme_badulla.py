...
csv_files = [
    "C:/Users/DELL/Desktop/all district/badulla/badulla.csv",
    "C:/Users/DELL/Desktop/all district/badulla/bandarawela.csv"
...
if all_data_frames:
    ...
    all_data.to_csv('Combined_Rainfall_All_Stations_badulla.csv', index=False)
    ...
    max_rainfall_per_day.to_csv('CSV_Extreme_Rainfall_By_Day_badulla.csv', index=False)
